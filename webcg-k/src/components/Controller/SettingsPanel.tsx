...
export function SettingsButton() {
	...
	// ─── 영상 입력 상태 ──────────────────────────────────────────
	const [videoInput, setVideoInput] = useState<VideoInputConfig>(() =>
		loadVideoInputConfig(),
	);
			...
			{isOpen && (
				...
				>
					...
					<div style={{ marginBottom: "1rem" }}>
						...
						>
							Motion 패키지는 그래픽 내부 SHOW/HIDE를 사용합니다. 이 값은
							manifest motion이 없는 legacy 블록에만 적용됩니다.
						</p>
						<div
						...
						<div style={{ display: "flex", gap: "0.5rem" }}>
							{[
								...
								<Button
									key={preset.value}
									variant={
										fadeDuration === preset.value ? "default" : "secondary"
									}
									size="sm"
					...
					>
						...
						>
							{[
								{
									mode: "off" as VideoInputMode,
									label: "OFF",
									icon: <CameraOff size={12} />,
								},
								{
									mode: "ndi" as VideoInputMode,
									label: "NDI",
									icon: <Monitor size={12} />,
								},
								{
									mode: "uvc" as VideoInputMode,
									label: "UVC",
									icon: <Camera size={12} />,
								},
							].map(({ mode, label, icon }) => (
