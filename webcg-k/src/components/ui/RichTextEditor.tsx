 ...
 *
 * 큐시트 속성 패널에서 CG 텍스트의 특정 단어/문장에
 * 색상·폰트 크기를 개별 지정할 수 있는 WYSIWYG 에디터.
 *
 * Why TipTap?: ProseMirror의 Mark 시스템이 방송 CG의
...
export function RichTextEditor({
    ...
    useEffect(() => {
        if (editor && content !== prevContentRef.current) {
            const newHtml = wrapPlainText(content);
            // 에디터의 현재 HTML과 다를 때만 업데이트 (무한 루프 방지)
