import { Layers, Loader2, Palette, Plus, Search } from "lucide-react";
...
import { useRundownActions, useRundownState } from "./RundownEditorContext";
								...
								return (
									...
									>
										...
										<div className="library-item-badges">
											{packageSummary.badgeLabels.slice(0, 4).map((badge) => (
												<span
						...
						<div className="section-import-toolbar">
							<div className="section-import-search">
								...
								<input
									...
									onChange={(event) =>
										setSectionImportSearch(event.target.value)
									}
							...
							<select
								...
								onChange={(event) =>
									setSectionImportScope(
										event.target.value as "all" | "workspace" | "public",
									)
								}
							>
