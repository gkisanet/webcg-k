...
const ENTER_PRESETS: { value: EnterAnimationType; label: string }[] = [
    ...
    { value: "maskInLeft", label: "마스크 인 · 왼쪽부터" },
    { value: "maskInRight", label: "마스크 인 · 오른쪽부터" },
...
const EXIT_PRESETS: { value: ExitAnimationType; label: string }[] = [
    ...
    { value: "maskOutLeft", label: "마스크 아웃 · 왼쪽부터" },
    { value: "maskOutRight", label: "마스크 아웃 · 오른쪽부터" },
];
...
// ─── 서브 컴포넌트: Enter/Exit 공통 컨트롤 (시간/이징) ───────
// Why 공통화?
// → Enter과 Exit의 컨트롤 UI가 구조적으로 동일 (시간/이징 2행).
