...
export function PropertiesPanel({
    ...
    const sendPluginMessage = useCallback((type: "SHOW" | "HIDE") => {
    ...
    const handleChange = (field: keyof GraphicElement, value: string | number | boolean) => {
        selectedElements.forEach((el) => {
    ...
    return (
        <div className="properties-panel">
            ...
            <div className="ins-tabs">
                ...
                {isShape && (
                    <button
                        ...
                        style={{ color: element.bindingContainer?.enabled ? "#60a5fa" : undefined }}
                    >
                        Bind
                    </button>
                )}
            ...
            {/* 탭 내용 — 각 서브 컴포넌트에 위임 */}
            {activeTab === "design" && <DesignTab {...tabCommonProps} />}
            {activeTab === "text" && isText && <TextTab {...tabCommonProps} />}
            {activeTab === "animate" && <AnimateTab element={element} onUpdate={onUpdate} />}
            {activeTab === "css" && <CssTab element={element} handleChange={handleChange} />}
            {activeTab === "bind" && isShape && <BindingTab element={element} onUpdate={onUpdate} />}
                        ...
                        <div className="ins-section-title">
                            ...
                            <button
                                ...
                                style={{
                                    ...
                                    fontSize: 11, cursor: isSyncing ? "not-allowed" : "pointer",
