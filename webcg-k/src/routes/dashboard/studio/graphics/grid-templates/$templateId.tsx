	...
	return (
		<div className="grid-editor-fullscreen">
			...
			<div className="grid-editor-fullscreen-header">
				...
				<NamingSearchBox
					ariaLabel="그리드 템플릿 이름"
					assetKind="grid_template"
					className="editor-title"
					placeholder="좌상단-하단자막-두글자..."
					value={templateName}
					onChange={(value) => {
						setTemplateName(value);
						setHasChanges(true);
					}}
					clearLabel="템플릿 이름 지우기"
					showLeadingIcon={false}
					suggestionTitle="그리드 템플릿 이름 만들기"
				...
				{/* 구분선 */}
				<div
					style={{ width: 1, height: 24, background: "var(--border-default)" }}
				/>
					...
					{bgImage && (
						<>
							...
							<input
								...
								disabled={!bgVisible}
							/>
							<span className="bg-opacity-value">
							...
							{seedZonesPercent.map((z: any) => (
								<div
									...
									style={{
										...
										height: `${z.pct.height}%`,
										background:
											ZONE_TYPE_COLORS[z.type] || "rgba(100,100,255,0.2)",
