...
출력은 순수 JSON만 허용합니다:
{"html":"...","css":"...","js":"...","dashboard_schema":{"properties":{}},"replicant_defaults":{}}
...
webcgk.motion.show(); webcgk.motion.hide(); webcgk.motion.refreshText();
\`\`\`
...
## WebCG-K Motion 선언
외부 애니메이션 라이브러리를 쓰지 말고 아래 선언을 HTML에 붙이세요. 실제 모션은 런타임이 처리합니다.
- 요소 진입/퇴장: \`data-motion="fade|lower-third|headline|scoreboard|stat|pop|slide-left|slide-right|slide-up|slide-down"\`.
- 텍스트 리빌: \`data-motion-text="chars|words|wipe"\`.
- 선택 옵션: \`data-motion-duration="520"\`, \`data-motion-delay="80"\`, \`data-motion-stagger="24"\`, \`data-motion-ease="cubic-bezier(.2,.8,.2,1)"\`.
- 직접 JS 모션이 꼭 필요하면 CSS keyframes 또는 \`webcgk.motion.*\`만 사용하세요.
