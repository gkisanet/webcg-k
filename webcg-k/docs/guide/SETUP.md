...
> [!IMPORTANT]
> **Supabase를 먼저 시작해야** webcg-k가 정상 동작합니다.
...
### 1. 회원가입
- http://localhost:3000 (WebCG-K) 접속
- 회원가입 페이지에서 계정 생성
...
# 5. 브라우저에서 회원가입 후 관리자 권한 부여

# 6. (선택) 데모 시드 삽입 (UUID 치환 필수)
...
- [USAGE.md](../USAGE.md) — 통합 사용 메뉴얼
- [TROUBLESHOOTING.md](./TROUBLESHOOTING.md) — 문제 해결 가이드
- [DESIGN.md](../../../DESIGN.md) — 디자인 시스템
- [DB.md](../../../supabase/docs/DB.md) — DB 스키마
